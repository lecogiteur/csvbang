/**
 *  fr.csvbang.test.bean.ChildBeanReflectionUtiTest
 * 
...
public class ChildBeanReflectionUtiTest extends BeanReflectionUtiTest {
	...
	/**
	 * {@inheritDoc}
	 * @see fr.csvbang.test.bean.BeanReflectionUtiTest#getProtectedField()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see fr.csvbang.test.bean.BeanReflectionUtiTest#simpleMethod()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see fr.csvbang.test.bean.BeanReflectionUtiTest#protectedMethod()
	 */
	@Override
