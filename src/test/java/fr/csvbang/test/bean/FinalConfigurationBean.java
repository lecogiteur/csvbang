/**
 *  fr.csvbang.test.bean.FinalConfigurationBean
 * 
...
public class FinalConfigurationBean extends ChildSimpleConfigurationBean {
	...
	/**
	 * {@inheritDoc}
	 * @see fr.csvbang.test.bean.ChildSimpleConfigurationBean#customMethod()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see fr.csvbang.test.bean.ChildSimpleConfigurationBean#getDate()
	 */
	@Override
	@CsvField(position=-2)
