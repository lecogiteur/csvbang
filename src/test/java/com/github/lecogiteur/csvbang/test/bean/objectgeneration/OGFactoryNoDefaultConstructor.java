/**
 *  com.github.lecogiteur.csvbang.test.bean.objectgeneration.OGFactoryNoDefaultConstructor
 * 
 ...
 * @since 1.0.0
 */
public class OGFactoryNoDefaultConstructor {
	 ...
	 * @since 1.0.0
	 */
	public OGFactoryNoDefaultConstructor(int constant) {
		super();
