...
public class StaticMethodObjectGeneratorTest {
	...
	public void simpleTest() throws CsvBangException{
		StaticMethodObjectGenerator<OGSMSimpleBean> generator = StaticMethodObjectGenerator.newInstance(OGSMSimpleBean.class);
	...
	public void noMethodTest() throws CsvBangException{
		StaticMethodObjectGenerator<OGSMNoMethod> generator = StaticMethodObjectGenerator.newInstance(OGSMNoMethod.class);
	...
	public void interfaceTest() throws CsvBangException{
		...
		StaticMethodObjectGenerator<OGSMInterfaceBean> generator = StaticMethodObjectGenerator.newInstance(OGSMInterfaceBean.class);
		...
		StaticMethodObjectGenerator<OGSMInterfaceResult> generator2 = StaticMethodObjectGenerator.newInstance(OGSMInterfaceResult.class);
		Assert.assertNull(generator2);
	}
	
	@Test
	public void childTest() throws CsvBangException{
		StaticMethodObjectGenerator<OGSMChildBean> generator = StaticMethodObjectGenerator.newInstance(OGSMChildBean.class);
